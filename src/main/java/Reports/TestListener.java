...
public class TestListener extends BasePage implements ITestListener {
    ...
    public void onFinish(ITestContext context) {
        ...
        String[] toEmails = {
            "deepak.kumar1@magicbricks.com",
            "testdeepak20@gmail.com",
            "magicbricks516@gmail.com",
            "rohit.negi@magicbricks.com"
        };

        SendReport.sendEmailWithReport(toEmails, reportPath);
